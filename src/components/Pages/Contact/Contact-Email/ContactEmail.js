        ...
        <div className={cx('mt-[2rem] border-[1px] lg:mx-[3rem] w-[100%]')}>
            <div className={cx(' flex text-[16px] py-[2rem] w-[100%]')}>
                ...
                <div className={cx('w-[60%] ml-[2rem] flex flex-col')}> 
                    <p>Pingo Craft</p>
                    <div className={cx(' lg:w-[675px] h-[94px] rounded-[10px] border-[1px]')}>
                        <textarea type={'text'} placeholder="Enter your inquiry details such as product name, color, size, quantity, material, etc." className={cx('lg:w-[665px] h-[84px] rounded-[10px] outline-none p-[10px]')}></textarea>
                    </div>
